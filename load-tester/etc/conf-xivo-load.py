...
answer_ring_time = {'distribution': 'uniform', 'min': 1000, 'max': 8000}
answer_talk_time = {'distribution': 'uniform', 'min': 10 * 1000, 'max': 30 * 1000}
call_talk_time = {'distribution': 'uniform', 'min': 60 * 1000, 'max': 180 * 1000}
...
scenarios.call_then_hangup = dict(
    ...
    called_extens = range(1500, 1510),
    talk_time = call_talk_time,
    rtp = rtp,
    sipp_call_rate = 1.0,
    sipp_rate_period_in_ms = 3000,
)
